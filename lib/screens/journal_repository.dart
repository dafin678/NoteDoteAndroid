...
class Repository with ChangeNotifier {
  ...
  Future postData(String title, String text) async{
      try {
        final response = await http.post(Uri.parse('https://notedote.herokuapp.com/api/journal/')
  ...
  Future putData(int id, String title, String text) async{
    try {
      final response = await http.put(Uri.parse('https://notedote.herokuapp.com/api/journal/${id.toString()}/'),
      body:{'title':title,'text':text});
  ...
  Future deleteData(int id) async{
    try {
      final response = await http.delete(Uri.parse('https://notedote.herokuapp.com/api/journal/${id.toString()}/'));
